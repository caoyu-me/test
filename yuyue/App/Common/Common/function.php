...
function dtimgs($img){
    ...
    foreach ($img as $key=>$value){
        ...
        echo "<section class='up-section fl'>
                <span class='up-span'></span>
                <img class=‘up-img’ src='$img[$key]' style='width: 189px;height: 180px;'>
                <img class='close-upimg' src='/Public/qwadmin/duotu/img/a7.png'>
                <p class='img-name-p'>233.jpg</p>
                <input id='taglocation' name='pic[]' value='$img[$key]' type='hidden'>
                <input id='tags' name='tags' value='' type='hidden'></section>";
    }
}
